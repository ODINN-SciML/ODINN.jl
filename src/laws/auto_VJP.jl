...
function prepare_vjp_law(
        ...
        law::Union{
            Law{<:Any, <:Any, <:Any, <:Any, <:Any, <:Any,
                <:Sleipnir.GenInputsAndApply{<:Any, <:Function}, CustomVJP},
            Law{<:Any, <:Any, <:Any, <:Any, <:Any, <:Any, <:Function, CustomVJP}},
        law_cache,
        θ,
        glacier_idx
)
...
function prepare_vjp_law(
        ...
        law::Union{
            ...
            Law{<:Any, <:Any, <:Any, <:Any, <:Any, <:Any,
                <:Sleipnir.GenInputsAndApply{<:Any, DIVJP}, <:Any}
        },
        law_cache,
        θ,
        glacier_idx
