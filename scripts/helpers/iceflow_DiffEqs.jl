...
"""
function train_iceflow_UDE(H₀, UA, θ, H_refs, temp_series, hyparams)
    ...
    iceflow_trained = DiffEqFlux.sciml_train(loss, θ, RMSProp(hyparams.η), cb=callback, maxiters = epochs)
