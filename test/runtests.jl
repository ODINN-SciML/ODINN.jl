...
@testset "Adjoint method of SIA equation with A as target and ice velocity loss" begin
    ...
    @testset "Manual implementation of the discrete adjoint with discrete VJP vs finite differences" test_grad_finite_diff(DiscreteAdjoint(VJP_method = DiscreteVJP()); thres = [1e-2, 1e-5, 1e-2], velocityLoss=true)
